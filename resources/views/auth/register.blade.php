    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <select class="block mt-1 w-full" id="genero" name='genero' :value="old('genero')" required autofocus autocomplete="genero">
            ...
            <div>
                ...
                <x-jet-input id="fechanacimiento" class="block mt-1 w-full" type="date" name="fechanacimiento" :value="old('fechanacimiento')" required autofocus autocomplete="fechanacimiento" />
            </div>
            <div>
